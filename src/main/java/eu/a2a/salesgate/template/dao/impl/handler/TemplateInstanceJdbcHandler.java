...
public class TemplateInstanceJdbcHandler extends JdbcHandler<TemplateInstance> {
  ...
  protected TemplateInstance createObjectFromResultSet(ResultSet rs) throws SQLException {
    ...
    if (contains("fk_distributore")) {
      ti.setDistributore(DistributoreFactory.newDistributore(rs.getString("fk_distributore"), null, null));
    }
