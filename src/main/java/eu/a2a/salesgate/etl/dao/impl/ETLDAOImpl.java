...
public class ETLDAOImpl implements ETLDAO {
  ...
  public List<ETLInstanceItem> estraiAllInstances(String eventCode) {
    ...
    String sql = "select ser.obj_id, cd_evento, cd_stato, ses.status, file_name, SER.D_POST_TIMESTAMP, SER.D_GET_TIMESTAMP, SER.D_END_TIMESTAMP, "
        + " SER.RECORD_PROCESSATI, SER.RECORD_SCARTATI, SER.RECORD_TOTALI, SER.LINK_FILE_SCARTI, SER.FILE_SCARTI " + " from sched_event_run ser, sched_event_status ses" + " where ser.cd_stato = ses.obj_id " + " and cd_evento = '"
        + eventCode + "' " + " order by obj_id desc ";
  ...
  public ETLInstanceItem estraiETLInstance(String eventCode, String objId) {
    ...
    String sql = "select ser.obj_id, cd_evento, cd_stato, ses.status, file_name, SER.D_POST_TIMESTAMP, SER.D_GET_TIMESTAMP, SER.D_END_TIMESTAMP, "
        + " SER.RECORD_PROCESSATI, SER.RECORD_SCARTATI, SER.RECORD_TOTALI, SER.LINK_FILE_SCARTI, SER.FILE_SCARTI " + " from sched_event_run ser, sched_event_status ses" + " where ser.cd_stato = ses.obj_id " + " and ser.obj_id = " + objId
        + " " + " order by obj_id desc ";

    ETLInstanceItem instance = jdbcTemplateSalesgate.query(sql, new ETLInstanceItemJdbcHandler().getResultSetExtractor());
