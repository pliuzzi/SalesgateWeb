...
public class PecServiceImpl implements PecService {
  ...
  private String getMailContent(String codServizio, String codFlusso, String utility) {
    ...
    if (codServizio.equals("TEM") && codFlusso.equals("E050") && utility.equals("ELE")) {
      ...
      return "<!DOCTYPE html><html><head><meta charset='ISO-8859-1'><style type='text/css'>body, html{margin: 0px;padding: 0px;}p{font-family: Calibri, Verdana, Sans-Serif;}p.normale{font-size: 12px;}p.grande {font-size: 14px;}</style></head><body><p class='normale'>Spettabile Distributore,<br>con la presente si comunicano in allegato le richieste di prestazione Switch con voltura Elettricità per conto dei nostri clienti finali in mercato libero.</p><p class='normale'>Vi comunichiamo che rinunciamo alla richiesta nel caso in cui il misuratore non fosse attivo.</p><p class='grande'><img src='http://www.a2aenergia.eu/home/export/system/modules/it.eutile.a2aenergia/resources/images/header-logo.png'/><small><br/>A2A Energia S.p.A.-Gruppo A2A<br/>P.za Trento, 13 - 20135 Milano<br/><b>PEC:</b> prestazioni.switchconvoltura.aen@pec.a2a.eu<br/><b>Web:</b> www.a2aenergia.eu</small></p></body></html>";
    } else if (codServizio.equals("SWVT") && codFlusso.equals("E050") && utility.equals("ELE")) {
      return "<!DOCTYPE html><html><head><meta charset='ISO-8859-1'><style type='text/css'>body, html{margin: 0px;padding: 0px;}p{font-family: Calibri, Verdana, Sans-Serif;}p.normale{font-size: 12px;}p.grande {font-size: 14px;}</style></head><body><p class='normale'>Spettabile Distributore,<br>con la presente si comunicano in allegato le richieste di prestazione Switch con voltura Elettricità per conto dei nostri clienti finali in mercato di maggior tutela.</p><p class='normale'>Vi comunichiamo che rinunciamo alla richiesta nel caso in cui il misuratore non fosse attivo.</p><p class='grande'><img src='http://www.a2aenergia.eu/home/export/system/modules/it.eutile.a2aenergia/resources/images/header-logo.png'/><small><br/>A2A Energia S.p.A.-Gruppo A2A<br/>P.za Trento, 13 - 20135 Milano<br/><b>PEC:</b> prestazioni.switchconvoltura.aen@pec.a2a.eu<br/><b>Web:</b> www.a2aenergia.eu</small></p></body></html>";
