	...
	"bs_two_button": {
		"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
		{
			...
			var sAppend = '<ul class="pagination">'+
				'<li class="prev"><a class="'+oSettings.oClasses.sPagePrevDisabled+'" tabindex="'+oSettings.iTabIndex+'" role="button"><i class="fa fa-chevron-left"></i>&nbsp;'+oLang.sPrevious+'</a></li>'+
				'<li class="next"><a class="'+oSettings.oClasses.sPageNextDisabled+'" tabindex="'+oSettings.iTabIndex+'" role="button">'+oLang.sNext+'&nbsp;<i class="fa fa-chevron-right"></i></a></li>'+
				'</ul>';
		...
		"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				$(nPaging).append(
					'<ul class="pagination">'+
					'<li class="disabled"><a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageFirst+'"><i class="fa fa-backward"></i>&nbsp;'+oLang.sFirst+'</a></li>'+
					'<li class="disabled"><a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPagePrevious+'"><i class="fa af-chevron-left"></i>&nbsp;'+oLang.sPrevious+'</a></li>'+
					'<li><a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageNext+'">'+oLang.sNext+'&nbsp;<i class="fa fa-chevron-right"></i></a></li>'+
					'<li><a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageLast+'">'+oLang.sLast+'&nbsp;<i class="fa af-forward"></siipan></a></li>'+
					'</ul>'
				);
				var els = $('a', nPaging);
				var nFirst = els[0],
