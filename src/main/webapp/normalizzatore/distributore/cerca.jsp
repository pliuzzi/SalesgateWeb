          ...
          <tbody>
            <c:forEach varStatus="iterSt" var="distributore" items="${listDistributori}">
              <tr data-codice-distributore="${distributore.id}">
                ...
                <td class="middle"><a title="Visualizza Distributore" href="${pageContext.request.contextPath}/app/normalizzatore/template/${distributore.id}/elenco" data-id="${distributore.id}" class="pointer"><span class="glyphicon glyphicon-new-window"></span></a></td>
              </tr>
            </c:forEach>
          </tbody>
          <tfoot>
