    ...
    <div class="panel-body">
      ...
      <div id="tabbContent" class="tab-content">
        <div id="outbound" class="tab-pane fade active in" style="margin-top: 10px;">
          <a class="btn btn-primary" style="margin-bottom: 10px;" href="${pageContext.request.contextPath}/app/normalizzatore/template/${distributore.id}/OUT/nuovo">Nuovo Template</a>
        ...
        <div id="inbound" class="tab-pane fade" style="margin-top: 10px;">
          ...
          <a class="btn btn-primary" style="margin-bottom: 10px;" href="${pageContext.request.contextPath}/app/normalizzatore/template/${distributore.id}/IN/nuovo">Nuovo Template</a>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-lg-6" align="center" style="border-right: #cccccc 1px solid">
            ...
            <a class="btn btn-info" id="downloadTemplateFile" href="${pageContext.request.contextPath}/app/normalizzatore/template/{id}/dowload"><span class="glyphicon glyphicon-download"></span> Download</a>
          </div>
...
function clonaTemplate(id, idDistributore, codiceServizio, codiceFlusso, utility){
    ...
    $("#btnCloneConfirm").on('click', function(e){
      ...
      $.ajax({
          async: false,
          url: "${pageContext.request.contextPath}/app/normalizzatore/template/clona",
          data: {
              idTemplate: id,
...
function modificaFile(id){
  ...
  $('#progress').css('display', 'none');
	$("#idTemplate").val(id);
	$("#downloadTemplateFile").attr('href', '${pageContext.request.contextPath}/app/normalizzatore/template/' + id + '/download');
...
$(function () {
    ...
    var url = "${pageContext.request.contextPath}/app/json/normalizzatore/template/upload";
  ...
  $('#tblTemplateInstanceOutbound').dataTable({
      ...
      aoColumns: [
               ...
               {mData: "id", sClass: "middle", mRender: function ( data, type, full ) {
                   return '<a title="Visualizza Template" href="${pageContext.request.contextPath}/app/normalizzatore/template/' + data + '/visualizza" data-id="'+data+'" class="pointer"><span class="glyphicon glyphicon-new-window"></span></a>';
               }},
             ]
    });
