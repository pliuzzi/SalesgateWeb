      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-lg-6" align="center" style="border-right: #cccccc 1px solid">
            ...
            <a class="btn btn-info" id="downloadTemplateFile" href="${pageContext.request.contextPath}/app/normalizzatore/template/{id}/dowload"><span class="fa fa-download"></span> Download</a>
          </div>
...
$(function () {
  ...
  $('#tblTemplateInstanceOutbound').dataTable({
      ...
      aoColumns: [
               ...
               {mData: "id", sClass: "middle", mRender: function ( data, type, full ) {
                   return '<a title="Visualizza Template" href="${pageContext.request.contextPath}/app/normalizzatore/template/' + data + '/visualizza" data-id="'+data+'" class="pointer"><span class="fa fa-edit"></span></a>';
               }},
             ]
    });
