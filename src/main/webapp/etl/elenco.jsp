...
<!-- Modal -->
<div class="modal fade" style="top: 60px;" id="modalPratiche" tabindex="-1" role="dialog" aria-labelledby="closeConfirmTitle" aria-hidden="true">
...
<script>
    ...
    // fine caricamento pagina
		...
		function loadTree() {
			$('#treePlaceholder').load(
							'${pageContext.request.contextPath}/app/etl/tree #tree',
    ...
    function viewETL(link){
	    $("body").css("cursor", "progress");
    	$('#etlContent').load('${pageContext.request.contextPath}/app/etl/' + link.data('etlEventCode') + '/instanze #content',
        function(responseText,textStatus,XMLHttpRequest) {
          $("body").css("cursor","default");
