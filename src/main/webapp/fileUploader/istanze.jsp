...
<div id="content">
  <div class="panel panel-primary">
    <div class="panel-heading">
      <h4 class="panel-title">Visualizza File Uploader</h4>
    </div>
                  ...
                  <tbody>
                    <c:forEach varStatus="iterSt" var="istanza" items="${istanze}">
                      <tr data-istanza-id="${istanza.id}">
                        <td class="middle"><a class="staging" name="staging" href="${pageContext.request.contextPath}/app/fileUploader/${istanza.eventCode}/${istanza.id}/staging">${istanza.id}</a></td>
