...
<div id="tree">
  <ul id="tabbTree" class="nav nav-tabs">
    <li class="active"><a href="#groupByDistributore">Per ${origineSelezionata} </a></li>
  ...
  <div id="tabbTreeContent" class="tab-content">
    <div id="groupByDistributore" class="tab-pane fade active in">
      <div class="tree">
        <ul>
          <c:forEach items="${fileUploaderNodeDistributore}" var="rootNode">
            <li><span><i class="fa fa-chevron-right"></i>&nbsp;&nbsp;${rootNode.utility}</span>
              <ul>
    ...
    <div id="groupByServizio" class="tab-pane fade">
      <div class="tree">
        <ul>
          <c:forEach items="${fileUploaderNodeServizio}" var="rootNode">
            <li><span><i class="fa fa-chevron-right"></i>&nbsp;&nbsp;${rootNode.utility}</span>
              <ul>
                <c:forEach items="${rootNode.nodes}" var="firstLevel">
                  <li><span><i class="fa fa-chevron-right"></i>&nbsp;&nbsp;${firstLevel.description}</span>
