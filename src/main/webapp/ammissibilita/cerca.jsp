...
<div>
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Cerca Pratica</li>
  </ol>
      ...
      <form:form modelAttribute="filtro" action="${pageContext.request.contextPath}/app/pratiche/gas/cerca" class="form-horizontal" method="post">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <form:label path="podPdr" cssClass="col-md-4">Pod / Pdr</form:label>
              <div class="col-md-8">
                <form:input path="podPdr" cssClass="form-control input-sm" type="text" />
              </div>
            </div>
          </div>
          <div class="col-md-6">
