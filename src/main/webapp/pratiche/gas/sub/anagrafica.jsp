                ...
                <div class="col-lg-8">
                  <spring:bind path="lavoriGasExtension.clienteFinale.nome">
                    <form:input type="text" class="form-control input-sm ${status.error ? 'has-error' : ''}"
                      path="lavoriGasExtension.clienteFinale.nome" readonly="${lavoriGas.isLavoriGasEditable}" data-toggle="tooltip"
              ...
              <div class="form-group">
                ...
                <div class="col-lg-8">
                  <spring:bind path="lavoriGasExtension.clienteFinale.cognome">
                    <form:input type="text" class="form-control input-sm ${status.error ? 'has-error' : ''}"
                      path="lavoriGasExtension.clienteFinale.cognome" readonly="${lavoriGas.isLavoriGasEditable}" data-toggle="tooltip"
                      title="${status.errorMessage}" data-container="body" data-placement="right" />
                  </spring:bind>
                </div>
              </div>
                ...
                <div class="col-lg-8">
                  <spring:bind path="lavoriGasExtension.clienteFinale.ragioneSociale">
                    <form:textarea type="text" class="form-control input-sm ${status.error ? 'has-error' : ''}"
                      path="lavoriGasExtension.clienteFinale.ragioneSociale" readonly="${lavoriGas.isLavoriGasEditable}"
                ...
                <div class="col-lg-8">
                  <spring:bind path="lavoriGasExtension.clienteFinale.piva">
                    <form:input type="text" class="form-control input-sm ${status.error ? 'has-error' : ''}" path="${status.expression}"
                      readonly="${lavoriGas.isLavoriGasEditable}" data-toggle="tooltip" title="${status.errorMessage}" data-container="body"
                ...
                <div class="col-lg-8">
                  <spring:bind path="lavoriGasExtension.clienteRef.ragioneSociale">
                    <form:textarea type="text" class="form-control input-sm ${status.error ? 'has-error' : ''}" rows="2"
                      path="${status.expression}" readonly="${lavoriGas.isLavoriGasEditable}" data-toggle="tooltip"
                      title="${status.errorMessage}" data-container="body" data-placement="right" />
                  </spring:bind>
                </div>
              </div>
