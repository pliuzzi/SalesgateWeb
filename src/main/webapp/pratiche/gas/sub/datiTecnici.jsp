              ...
              <div class="form-group">
                ...
                <div class="col-lg-5">
                  <spring:bind path="lavoriGasExtension.flagNecessario">
                    <form:input type="text" class="form-control input-sm ${status.error ? 'has-error' : ''}" path="${status.expression}" readonly="${lavoriGas.isLavoriGasEditable}"
              ...
              <div class="form-group">
                ...
                <div class="col-lg-8">
                  <spring:bind path="lavoriGasExtension.motivazioneAgenda">
                    <form:textarea type="text" class="form-control input-sm ${status.error ? 'has-error' : ''}" rows="2" path="${status.expression}" readonly="${lavoriGas.isLavoriGasEditable}"
                      data-toggle="tooltip" title="${status.errorMessage}" data-container="body" data-placement="right" />
                  </spring:bind>
                </div>
              </div>
