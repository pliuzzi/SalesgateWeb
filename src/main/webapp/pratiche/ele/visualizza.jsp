    ...
    <div class="panel-body">
      <form:form modelAttribute="lavoriEle" commandName="lavoriEle" action="${pageContext.request.contextPath}/app/pratiche/ele/modifica" class="form-horizontal" method="post">
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <fieldset>
                <legend>File</legend>
                <!-- <button id="btnDownload" onClick="dowloadFile('${lavoriEle.lavoriEleExtension.fkFiles}')"
                  class="btn btn-success ${empty fn:trim(lavoriEle.lavoriEleExtension.fkFiles) ? 'disabled' : ''}">
        ...
        <ul id="tabb" class="nav nav-tabs">
          ...
          <spring:bind path="lavoriEleExtension.convertitore*">
