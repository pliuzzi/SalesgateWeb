  ...
  <div class="panel panel-primary">
    <div class="panel-heading clearfix">
      ...
      <div class="btn-group pull-right">
        <a href="${pageContext.request.contextPath}/app/pratiche/ele/cerca" class="btn btn-default"><i class="fa fa-times"></i> Annulla</a>
    ...
    <div class="panel-body">
      <form:form modelAttribute="lavoriEle" commandName="lavoriEle" action="${pageContext.request.contextPath}/app/pratiche/ele/modifica" class="form-horizontal" method="post">
        ...
        <form:hidden path="lavoriEleExtension.fkLavoriEle" />
        <form:hidden path="lavoriEleExtension.codiceFlusso" />
        ...
        <form:hidden path="lavoriEleExtension.gestApp" />
          ...
          <div class="row">
            <div class="col-md-4">
              <fieldset>
                  ...
                  <div class="col-lg-5">
                    <div class="input-group input-group-sm">
                      ...
                      <span class="input-group-btn">
                        <a class="btn btn-default" href="${pageContext.request.contextPath}/app/log/salesgate?appKey1=${lavoriEle.idSistemaSorgente }"><i class="fa fa-external-link"></i></a>
                      </span>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-lg-5">
                    <div class="input-group input-group-sm">
                      ...
                      <span class="input-group-btn">
                        <a class="btn btn-default" href="${pageContext.request.contextPath}/app/log/salesgate?appKey3=${lavoriEle.id }"><i class="fa fa-external-link"></i></a>
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="input-group input-group-sm">
                      <spring:bind path="codicePraticaDl" >
                        <form:input type="text" class="form-control input-sm ${status.error ? 'alert-danger' : ''}" path="codicePraticaDl"
                          readonly="${lavoriEle.isCodicePraticaDlReadOnly}" 
                          data-toggle="tooltip" title="${status.errorMessage}" data-container="body" data-placement="right"/>
                      </spring:bind>
                      <span class="input-group-btn">
                        <a class="btn btn-default ${empty lavoriEle.codicePraticaDl ? 'disabled' : ''}" href="${pageContext.request.contextPath}/app/log/salesgate?appKey2=${lavoriEle.codicePraticaDl }"><i class="fa fa-external-link"></i></a>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <form:label path="pod" class="col-lg-7 control-label">POD</form:label>
                  <div class="col-lg-5">
                    <!-- <p class="form-control-static input-sm" th:text="pdr}">${id}</p>-->
                    <form:input type="text" class="form-control input-sm" readOnly="true" path="pod" />
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <c:if test="${not empty fn:trim(lavoriEle.lavoriEleExtension.fkFiles)}">
                    <div class="col-lg-5">
                      <a target="_blank" href="${pageContext.request.contextPath}/app/files/${lavoriEle.lavoriEleExtension.fkFiles}/download" id="lnkDownload"
                        data-id-file="${lavoriEle.lavoriEleExtension.fkFiles}" class="btn btn-success ${empty fn:trim(lavoriEle.lavoriEleExtension.fkFiles) ? 'disabled' : ''}"> <span
        ...
        <ul id="tabb" class="nav nav-tabs">
          <spring:bind path="lavoriEleExtension.cliente*">
          ...
          <spring:bind path="lavoriEleExtension.indirizzo*">
          ...
          <spring:bind path="lavoriEleExtension.misuratore*">
          ...
          <spring:bind path="lavoriEleExtension.date*">
          ...
          <spring:bind path="lavoriEleExtension.*">
