...
<div>
  <form:form modelAttribute="templateInstance" commandName="templateInstance" action="${pageContext.request.contextPath}/app/normalizzatore/templatevenditore/modifica" class="form-horizontal" method="post">
    <ol class="breadcrumb">
      ...
      <li><a href="${pageContext.request.contextPath}/app/venditore/visualizza/${templateInstance.venditore.id}">${templateInstance.venditore.nome }</a></li>
      <li><a href="${pageContext.request.contextPath}/app/normalizzatore/templatevenditore/${templateInstance.venditore.id}/elenco">Visualizza Template</a></li>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <div class="well">
          ...
          <form:input type="hidden" path="venditore.id" />
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <fieldset>
                ...
                <div class="form-group">
                  <form:label path="venditore.nome" class="col-lg-2 control-label">Nome</form:label>
                  <div class="col-lg-10">
                    <spring:bind path="venditore.nome">
                      <p class="form-control-static">${status.value}</p>
                      <form:hidden path="${status.expression}" />
                      <!--<form:input type="text" class="form-control ignore input-sm ${status.error ? 'has-error' : ''}" path="${status.expression}" 
                      data-toggle="tooltip" title="${status.errorMessage}" data-container="body" data-placement="right"
            ...
            <div class="col-lg-4" align="right">
              <div class="btn-group">
                <a href="${pageContext.request.contextPath}/app/normalizzatore/templatevenditore/${templateInstance.venditore.id}/elenco" class="btn btn-default"><span class="fa fa-times-circle"></span> Annulla</a> <a href="#" onClick="showConfirm()" class="btn btn-primary"><span class="fa fa-save"></span> Salva</a>
              </div>
              ...
              <fieldset>
                ...
                <div class="row">
                  <div class="col-lg-6" align="center" style="border-right: #cccccc 1px solid">
                    ...
                    <a class="btn btn-info" id="downloadTemplateFile" href="${pageContext.request.contextPath}/app/normalizzatore/templatevenditore/${templateInstance.anagTemplate.id}/download"><span class="fa fa-download"></span> Download</a>
                  </div>
