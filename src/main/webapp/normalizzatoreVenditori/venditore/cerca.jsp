...
<div>
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      <form:form modelAttribute="filtro" action="${pageContext.request.contextPath}/app/normalizzatore/cercavenditore" class="form-horizontal" method="post">
        <div class="row">
          <div class="col-md-6">
          ...
          <tbody>
            <c:forEach varStatus="iterSt" var="venditore" items="${listVenditori}">
              <tr data-codice-venditore="${venditore.id}">
                ...
                <td class="middle"><a title="Visualizza Venditore" href="${pageContext.request.contextPath}/app/normalizzatore/templatevenditore/${venditore.id}/elenco" data-id="${venditore.id}" class="pointer"><span class="fa fa-edit"></span></a></td>
              </tr>
            </c:forEach>
          </tbody>
          <tfoot>
